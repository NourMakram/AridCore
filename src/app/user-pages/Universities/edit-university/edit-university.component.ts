...
@Component({
  ...
  styleUrl: './edit-university.component.css'
})
export class EditUniversityComponent {
  AddForm: FormGroup;
  id: any;
  constructor(private fb: FormBuilder, private countryService: CountryService,
    private universityService: UniversityService, private Router: Router, private activeRouter: ActivatedRoute) {
  ...
  Submit() {
    if (this.AddForm.valid) {
      ...
      this.universityService.Edit(Data).subscribe({
        next: () => {
  ...
  ConvertData() {
    ...
    formData.append('isIndexed', this.AddForm.get('isIndexed')?.value);
    formData.append('isVisible', this.AddForm.get('isVisible')?.value);
      ...
      next: (value) => {
        if (value != null) {
          this.AddForm.patchValue({
            arUniversityName: value.arUniversityName,
            enUniversityName: value.enUniversityName,
            website: value.website,
            staffNo: value.staffNo,
            studentNo: value.studentNo,
            yearofEstablishment: value.yearofEstablishment,
