...
@Component({
  selector: 'app-add-certificate-template',
  standalone:true,
  imports:[ReactiveFormsModule,RouterLink,CommonModule],
  templateUrl: './add-certificate-template.component.html',
  styleUrl: './add-certificate-template.component.css'
})
export class AddCertificateTemplateComponent {
