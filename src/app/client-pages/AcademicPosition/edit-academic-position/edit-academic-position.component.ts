...
@Component({
  selector: 'app-edit-academic-position',
  imports:[RouterLink,CommonModule,ReactiveFormsModule],
  standalone:true,
  templateUrl: './edit-academic-position.component.html',
  styleUrl: './edit-academic-position.component.css'
})
export class EditAcademicPositionComponent {
...
this.AcademicPositionForm = this.fb.group({
  ...
  Submit() {
    if (this.AcademicPositionForm.valid) {
      ...
      this.academicPositionService.Edit(this.AcademicPositionForm.value).subscribe({
        next: () => {
  ...
  //=============================================================================
   Get(id:number){
    this.academicPositionService.Get(id).subscribe({
       next:(value)=>{
        this.AcademicPositionForm.patchValue({
